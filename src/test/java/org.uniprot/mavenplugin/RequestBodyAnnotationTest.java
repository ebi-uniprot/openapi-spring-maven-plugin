...
public class RequestBodyAnnotationTest extends BaseAnnotationTest {
    ...
    public void testGeneralRequestBody() throws Exception {
        ...
        generateOAS3("org.uniprot.mavenplugin.swagger.requestbody.general", "request-body-general.yaml");
    ...
    public void testRequestBodyAroundMethod() throws Exception {
        // generate OAS for the given package
        generateOAS3("org.uniprot.mavenplugin.swagger.requestbody.onlymethod", "request-body-method.yaml");
    ...
    public void testRequestBodyAroundMethodAndParam() throws Exception {
        // generate OAS for the given package
        generateOAS3("org.uniprot.mavenplugin.swagger.requestbody.methodandparam", "request-body-method-param.yaml");
