package org.uniprot.mavenplugin.echo;
...
//@Api(value = "/echo", description = "Set of simple endpoints that return whatever value you pass in") TODO
//FIXME produces of method should overrride class level
...
public class EchoResource {
    ...
    @Operation(summary = "")// TODO error {parameterName} needs to be defined
    ...
    @Operation(summary = "")// TODO produces should include json only not xml
    ...
    @Operation(summary = "")// TODO in: "cookie"
