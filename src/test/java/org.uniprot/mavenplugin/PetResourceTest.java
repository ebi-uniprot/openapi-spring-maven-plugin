...
public class PetResourceTest extends AbstractMojoTestCase {
    ...
    public void testGenerateOpenAPI() throws Exception {
        File testPom = getTestFile("src/test/resources/poms/pet-resource-pom.xml");
        ...
        // expected yaml file
        File expectedYamlFile = new File("src/test/resources/expected-output/pet-resource.yaml");
        ...
        // generated file
        File generatedYamlFile = new File("target/generated-sources/swagger/pet-resource.yaml");
